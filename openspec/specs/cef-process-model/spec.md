# cef-process-model Specification

## Purpose

Defines how the single gtk-cef-shell binary acts as both the CEF browser
process and CEF subprocesses, how the browser process initialises CEF, how
the external message pump is driven, and what Chromium command-line
switches are applied for Wayland-first hosts.
