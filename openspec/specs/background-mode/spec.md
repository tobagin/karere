# background-mode Specification

## Purpose

Defines how Karere keeps running in the background: requesting autostart via
the XDG Background portal, hiding the window on close-to-background instead of
exiting, and the Cargo dependency surface (`ashpd`, `tokio`) that backs these
behaviours.
