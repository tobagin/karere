# cef-binary-provisioning Specification

## Purpose

Defines how contributors obtain the upstream CEF distribution that the build
links against and how that distribution is exposed to cargo via `CEF_PATH`.
