# js-fullscreen-handler Specification

## Purpose

Allow JS-initiated fullscreen requests from WhatsApp Web (e.g. video calls) to drive the GTK window's fullscreen state, while keeping the Adwaita headerbar visibility in sync regardless of how fullscreen is entered or exited.
