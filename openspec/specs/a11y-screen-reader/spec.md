# a11y-screen-reader Specification

## Purpose

Provide a screen-reader optimization option that enables Chromium caret browsing in the CEF runtime via a restart-required GSettings key.
